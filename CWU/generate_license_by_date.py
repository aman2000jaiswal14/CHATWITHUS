...
def generate_license_by_date(customer_name, expiry_date_str, license_type="PREMIUM", provided_to="ABC", project="ChatWithUs", version="1.0.0", description="ChatWithUs Enterprise License", modules="VOICE,MARKDOWN,E2E,NOTIFICATIONS,GENERAL_AI", allowed_chars=r"^[A-Za-z0-9\s.,!?'\"@_\-+*~\\`]+$"):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        ...
        modules = sys.argv[8] if len(sys.argv) > 8 else "VOICE,MARKDOWN,E2E,NOTIFICATIONS,REPLY,GENERAL_AI"
