...
urlpatterns = [
    ...
    path('api/status/ai/', views.api_ai_status, name='chat_ai_status'),
    ...
    re_path(r'^api/acall/bas/?$', views.api_generate_token, name='chat_generate_token'),
    path('api/auth/token/', views.api_generate_token),
